...
void Main()
{
	...
	while (System::Update())
	{
		...
		// 家ボタン
		if (Button(Rect{ 340, 40, 420, 100 }, farmEmoji, font, U"チョコ屋", U"C{} / 1 CPS"_fmt(farmCost), farmCount, (farmCost <= cookies)))
		{
			cookies -= farmCost;
			++farmCount;
		}
		...
		// 工場ボタン
		if (Button(Rect{ 340, 160, 420, 100 }, factoryEmoji, font, U"チョコ工場", U"C{} / 10 CPS"_fmt(factoryCost), factoryCount, (factoryCost <= cookies)))
		{
			cookies -= factoryCost;
			++factoryCount;
		}
